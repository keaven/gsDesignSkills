...
- The skills site does not require `gsDesign.ai` at runtime
...
`.agents/skills/gsDesign/SKILL.md`.
```
...
or earlier gsDesign.ai exports, but they are vendored into `gsDesignSkills`.
